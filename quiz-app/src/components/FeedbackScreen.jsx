...
export default function FeedbackScreen({ isSuccess, correctAnswer, onNext, currentThemeQuestion }) {
    ...
    >
      ...
      {!isSuccess && (
        <p className="text-gray-700 mb-4">
          ...
          <strong className="text-xl text-gray-900">{correctAnswer}</strong>
        </p>
      )}
      
      <button 
        onClick={onNext}
        className={`w-full font-bold py-2 rounded-lg mt-2 active:scale-95 transition-transform ${
